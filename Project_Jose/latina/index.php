...
<div class="preload">
<img src="images/main_banner_bg0.png" alt="노란색 배경" width="1000px" height="0px"/>
<img src="images/main_banner_bg2.png" alt="자주색 배경" width="1000px" height="0px"/>
<img src="images/main_banner_bg3.png" alt="초록색 배경" width="1000px" height="0px"/>
<img src="images/main_banner_bg4.png" alt="파란색 배경" width="1000px" height="0px"/> 
...
de5();
de6();
document.addEventListener("DOMContentLoaded", function(){location.replace("index.html");      
});
}, 8000);
...
<div class="skipMenu">
    ...
    <div id="wrapup" class="main_banner_load"></div>
...
<div id="wrapup" class="main_banner_wrap">
   ...
   <p class="banner_date">1994년 설립 / Established in 1994</p><span class="linebox"><a href=""><img src="images/img_banner1.jpg" alt="멕시코 아즈텍 유물 태양의 돌"/></a></span></li>

   <li class="banner3"><h3><a href="">신화가 된 욕망&#44;<br>엘도라도 황금전</a></h3>
       <p class="banner_date">2020. 3. 27 ~ 2020. 4. 8</p> <span class="linebox"><a href=""><img src="images/img_banner2.jpg" alt="멕시코 아즈텍 유물 태양의 돌"/></a></span></li>
   
   <li class="banner4"><h3><a href="">2020<br>조각광장 목련축제</a></h3>
       <p class="banner_date">2020. 4. 10 ~ 2020. 8. 8</p> <span class="linebox"><a href=""><img src="images/img_banner3.jpg" alt="멕시코 아즈텍 유물 태양의 돌"/></a></span></li>
   <li class="banner1"><h3><a href="">한-에콰도르 수교 70주년<br>과야사민 특별전</a></h3>
       <p class="banner_date">2020. 2. 22 ~ 2020. 5. 8</p> <span class="linebox"><a href=""><img src="images/img_banner4.jpg" alt="멕시코 아즈텍 유물 태양의 돌"/></a></span>
    </li>
     </ol>   
...
-->
   ...
   <a class="plus" href="/information.html">더보기</a>
    ...
    <div class="notice">    
        <h2>&#124; 공지사항</h2>
    <div id="board_area" class="boardbox"> 
    <table class="listtable">
         ...
         if(isset($_GET['page'])){
          $page = $_GET['page'];
              ...
              $title=$board["ttitle"]; 
                if(strlen($title)>25)
                { 
                  $title=str_replace($board["ttitle"],mb_substr($board["ttitle"],0,25,"utf-8")."...",$board["ttitle"]);
                }
      ...
      <tbody>
        <tr class="bborder">
          ...
          <td class="date" width="100"><?php echo $newDate?></td> 
  ...
  <div class="shortcut">
   ...
   <div class="external_event">
    ...
    <div class="SNS">
        ...
        <li class="facebook"><a href="https://www.facebook.com/latinamuseum/posts/3358843547481645">페이크북</a></li>
        <li class="instagram"><a href="https://www.instagram.com/explore/tags/%EC%A4%91%EB%82%A8%EB%AF%B8%EB%AC%B8%ED%99%94%EC%9B%90/">맛스타그램</a></li>
...
$('.main_banner_load').css('opacity','0');     
$('.main_banner_load').css('zIndex','-9999');
</script>    
