...
<head>
 ...
 <link rel="shortcut icon" href="../favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="jardin.css"/>
    <style>
...
<div class="main_wrap">
<h1 class="title">시설 안내</h1>
<span class=line1></span>
<div class="shortcut">
	<h2>항목별 바로가기</h2>
	<ul>
		<li class="shortcuta"><a href="#general">차와 식사</a></li>
		<li class="shortcutb"><a href="#location">문화 시설</a></li>
		<li class="shortcutc"><a href="#booking">시설 안내도</a></li>
		<li class="shortcutd"><a href="#inquiry">주변 명소</a></li>
	</ul>
</div>
<section class="first"> 
<div id="general"></div>
