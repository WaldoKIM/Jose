...
<div class="main_wrap">
<h1 class="title">문화원 소식</h1>
<span class=line1></span>
<div class="shortcut">
	<h2>주요안내 바로가기</h2>
	<ul>
		<li class="shortcuta"><a href="#general">타코 하우스</a></li>
		<li class="shortcutb"><a href="#location">행사 안내</a></li>
		<li class="shortcutc"><a href="#booking">공지사항</a></li>
		<li class="shortcutd"><a href="#inquiry">문화원 소식</a></li>
	</ul>
</div>
<div id="general"></div>	
<div id="location"></div>
